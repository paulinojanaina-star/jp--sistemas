    ...
    <div className="space-y-6 p-4 md:p-8 animate-fade-in-up max-w-7xl mx-auto">
      ...
      <Tabs defaultValue="catalogo" className="w-full">
        <TabsList className="grid w-full grid-cols-2 max-w-[400px] mb-6">
          <TabsTrigger value="catalogo" className="font-bold">
            Catálogo e Estoque
          </TabsTrigger>
          <TabsTrigger value="financeiro" className="font-bold">
            Controle Financeiro
          </TabsTrigger>
        </TabsList>
        <TabsContent value="catalogo" className="space-y-6 animate-fade-in">
        ...
        <TabsContent value="financeiro" className="animate-fade-in">
          <FinancialTab />
        </TabsContent>
      </Tabs>
    </div>
